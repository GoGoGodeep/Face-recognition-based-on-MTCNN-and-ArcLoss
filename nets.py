...
class PNet(nn.Module):
    def __init__(self):
        ...
        self.comv4_2 = nn.Conv2d(32, 14,kernel_size=1,stride=1)
...
class ONet(nn.Module):
    def __init__(self):
        ...
        self.conv6_1 = nn.Linear(256, 1)    # 1个置信度
        self.conv6_2 = nn.Linear(256, 14)    # 中心点、宽高
    ...
    def forward(self, x):
        ...
        x = self.prelu5(x)
        # detection
        conf = torch.sigmoid(self.conv6_1(x))  # 置信度
